...
final class SpeechBubbleView: NSView {
    ...
    override init(frame frameRect: NSRect) {
        ...
        primaryTopToImageTitle = primary.topAnchor.constraint(equalTo: imageTitleLabel.bottomAnchor, constant: 8)
        ...
        secondaryTopToImageTitle = secondary.topAnchor.constraint(equalTo: imageTitleLabel.bottomAnchor, constant: 8)
